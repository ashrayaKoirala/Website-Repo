...
import { Captions, Download, Type, Upload } from "lucide-react"
    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
      ...
      >
        <div className="max-w-md mx-auto">
          ...
          <h2 className="text-xl font-semibold font-mono mb-2">Generate Video Subtitles</h2>
          <p className="text-gray-600 mb-6">Create and style professional subtitles automatically from your video</p>
